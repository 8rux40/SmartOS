...
<div class="container">
    ...
    <div class="card">
      <div class="card-body">
  <form action="" method="post" id="editarOrcamento">
  @csrf  
  <div class="row">
    <div class="col-md-6">
  ...
  <div class="row">
      <div class="col-md-12">
          <div class="form-group">
              ...
              <textarea class="form-control" id="DescricaoProblema" rows="4" required name="descricao_problema">{{$orcamento->descricao_problema}}</textarea>
          </div>
      </div>
  </div> 
  <div class="row">
