<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <button wire:click="resetInputFields()" data-toggle="modal" data-target="#createModal" class="btn btn-md bg-success text-light float-right"><i class="fas fa-plus"></i>&nbsp;&nbsp;Novo</button>
